...
public class RandomNumberButtonAssignment extends Application{
	private int rand;
	...
	public void start(Stage primaryStage) {
		...
		Button push = new Button("Press Me For A Random Number!");
		...
		primaryStage.setTitle("Random Number 1-6");
